...
public final class Constants {
  public static final class DriveConstants {
    ...
    // NetworkTables
    public static final NetworkTable kDriveNetworkTable = NetworkTableInstance.getDefault().getTable("Drive");
    public static final StructArrayPublisher<SwerveModuleState> kDesiredModuleStatesPublisher = kDriveNetworkTable.getStructArrayTopic("DesiredStates", SwerveModuleState.struct).publish();
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDrivingMotorPinionTeeth = 1;

    // Calculations required for driving motor conversion factors and feed forward
    public static final double kDrivingMotorFreeSpeedRps = NeoVortexConstants.kFreeSpeedRpm / 60;
    public static final double kWheelDiameterMeters = 0.09702;
