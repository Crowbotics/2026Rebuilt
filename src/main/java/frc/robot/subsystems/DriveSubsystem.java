...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configure(
            ...
            Constants.DriveConstants.config, // The robot configuration
            () -> {
    ...
    Auto = new PathPlannerAuto("Collect Fuel");
  }
  ...
  public void periodic() {
    ...
    DriveConstants.kCurrentModuleStatesPublisher.set(currentModuleStates);
  }
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    DriveConstants.kDesiredModuleStatesPublisher.set(swerveModuleStates);
  ...
  public PathPlannerAuto getDriveAuto() {
    return Auto;
  }
}
